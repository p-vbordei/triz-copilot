...
class CompleteTRIZSolver:
    ...
    def solve_completely(self, problem_description: str) -> Dict[str, Any]:
        ...
        technical_contradictions = self._identify_technical_contradictions(problem_description)
        physical_contradictions = self._identify_physical_contradictions(problem_description)
        ...
        principles_solutions = self._apply_inventive_principles(technical_contradictions)
        
        # 5b. Separation Principles for physical contradictions
        separation_solutions = self._apply_separation_principles(physical_contradictions)
        
        # 5c. Substance-Field Analysis (if applicable)
        sf_solutions = self._substance_field_analysis(problem_description, function_analysis)
    ...
    def _analyze_functions(self, problem: str) -> FunctionAnalysis:
        """
        TRIZ Function Analysis - identify all functions in the system.
        """
        # TODO: Implement with NLP or structured prompts
    ...
    def _analyze_resources(self, problem: str) -> ResourceInventory:
        ...
        return ResourceInventory(
            substance_resources=["Aluminum", "CFRP available", "Workshop tools", "Heat gun"],
            ...
            time_resources=["Can heat material before forming", "Curing time available"],
            information_resources=["Materials books", "TRIZ knowledge", "Engineering data"]
        )
    
    def _formulate_ifr(self, problem: str, functions: FunctionAnalysis) -> Dict[str, str]:
        """
        ...
        return {
            ...
            "trimming_candidates": ["Separate forming step", "Heavy material", "Complex tooling"]
        }
    
    def _identify_technical_contradictions(self, problem: str) -> List[TechnicalContradiction]:
        """
    ...
    def _identify_physical_contradictions(self, problem: str) -> List[PhysicalContradiction]:
        """
    ...
    def _apply_inventive_principles(self, contradictions: List[TechnicalContradiction]) -> List[Dict]:
        """
    ...
    def _apply_separation_principles(self, contradictions: List[PhysicalContradiction]) -> List[Dict]:
        """
    ...
    def _substance_field_analysis(self, problem: str, functions: FunctionAnalysis) -> List[Dict]:
        """
    ...
    def _is_materials_problem(self, problem: str) -> bool:
        ...
        materials_keywords = ["material", "weight", "lightweight", "formability", "bendable", "aluminum", "cfrp"]
    ...
    def _build_comparison_table(self, materials: Dict[str, MaterialProperty]) -> List[Dict]:
        ...
        for name, props in materials.items():
            table.append({
                ...
                "weight_vs_aluminum": f"{((props.density / 2.7 - 1) * 100):+.0f}%" if props.density else "N/A",
                "source": props.source_book
            })
        return table
    
    def _synthesize_solutions(self, principles_solutions, separation_solutions, sf_solutions, materials_analysis) -> List[Dict]:
        """
        ...
        for principle_sol in principles_solutions[:3]:
            ...
            if materials_analysis:
                solution["specific_materials"] = materials_analysis.get("materials_identified", [])
